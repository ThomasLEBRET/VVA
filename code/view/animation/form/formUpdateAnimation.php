...
<form class="justify" action="index.php?page=tryUpdateAnimation" method="POST">
  ...
  <div class="form-row">
    <div class="col-md-3 mb-3">
      ...
      <input value="<?=date('Y-m-d', strtotime($animation->getDatevaliditeanim()))?>" name="datevaliditeanim" type="date" min="<?= date('Y-m-d'); ?>" class="form-control" id="datevalidite" required>
    </div>
    <div class="col-md-3 mb-3">
