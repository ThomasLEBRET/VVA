...
<form class="justify" action="index.php?page=modifierActivite" method="POST">
  ...
  <div class="form-row">
    <div class="col-md-3 mb-3">
      ...
      <input value="<?=$activite->getDateact()->format('Y-m-d')?>" name="dateact" type="date" min="<?= date('Y-m-d') ?>" max=<?=$animation->getDatevaliditeanim()->format('Y-m-d')?> class="form-control" id="dateact" required>
    </div>
    <div class="col-md-3 mb-3">
